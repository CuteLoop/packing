...
\]
Symmetry of $q$ ensures the satisfaction of detailed balance with respect to
$\pi_{T_k}$. We need detailed balance to guarantee convergence of our Markov chain 
to the target distribution. The resulting transition kernel is
\[
  P_k(\conf \to d\conf')
...
As stated in the notes from Sokal, "Monte Carlo is an extremely bad method; it should be used only when all alternative methods are 
worse. "
Convergence to the global minimum under the Metropolis--Hastings dynamics
